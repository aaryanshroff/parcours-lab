...
_BASE_SYSTEM_INSTRUCTION = (
    ...
    "If the user's message is not about learning paths, courses, goals, or career development, "
    "respond ONLY with: \"I'm here to help with your learning path and course recommendations. What skills or goals are you working toward?\"\n"
